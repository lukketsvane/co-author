...
Spørsmålet er gamalt. Svara har vore mange: forma følger funksjonen, forma følger materialet, forma følger marknaden, forma følger tidsånda. Kvar av desse svara fangar noko reelt, men ingen av dei er tilstrekkelege åleine, fordi ingen av dei kan forklare den enorme variasjonen i form som me observerer innanfor kvar funksjonelle klasse. 93 stolar med same funksjon varierer 15 gonger i symmetri, 3 gonger i djupn og 2,6 gonger i kompaktheit. Funksjonen forklarer ingenting av denne variasjonen, fordi funksjonen er konstant. Noko anna er på ferde.

Traktaten byggjer eit rammeverk som identifiserer dette "noko anna." Rammeverket har fire hovudkomponentar: eit *formrom* (rommet av alle moglege former), *seleksjonstrykk* (kreftene som favoriserer visse former framfor andre), eit *tilpassingslandskap* (den samla effekten av alle trykka), og *navigatorar* (det som responderer på trykka og realiserer former). Hovudpåstanden er at dette rammeverket gjeld uavhengig av substrat: same struktur beskriv korleis ein handverkar, ein algoritme, ein biologisk vekstprosess og ein marknad produserer form.

**Kva traktaten er.** Eit logisk rammeverk i traktatform. Proposisjonane er nummererte etter Wittgensteins konvensjon: proposisjon 1.1 utdjupar proposisjon 1, proposisjon 1.11 utdjupar 1.1, og so bortetter. Dei sju hovudproposisjonane kan lesast åleine som eit samandrag. Resten er utdjuping.

Kvar proposisjon er merka med sin logiske status:
- **[Definisjon]** stipulerer tyding for eit omgrep
- **[Aksiom]** er eit premiss som vert teke for gjeve, med eksplisitte falsifiseringsvilkår
- **[Teorem]** følger deduktivt frå definisjonar og aksiom
- **[Observasjon]** er ein empirisk påstand som støttar eller motiverer, men som ikkje har logisk naudsynt status
- **[Illustrasjon]** er eit eksempel som gjer eit poeng konkret, utan logisk vekt

**Kva traktaten ikkje er.** Ho er ikkje ein teori om god design. Ho skil ikkje mellom vakre og stygge former, mellom vellukka og mislukka objekt. Ho skildrar *mekanismane* som produserer form, ikkje *normane* som vurderer den. Ho er heller ikkje ein kausalteori: rammeverket er eit *analytisk vokabular*, eit koordinatsystem for å stille presise spørsmål om form, ikkje ein mekanisme som produserer svar av seg sjølv. Formrommet er konstruert, ikkje funne; aksane er valde; metrikken er stipulert. Verdien ligg i at vokabularet tvingar analytikaren til å spesifisere kvart ledd, og at spesifikasjonane er falsifiserbare.

**Formell søstertekst.** FORMLÆRE: MATHEMATICA byggjer same rammeverk i formell notasjon med eksplisitte bevis. Kryssreferansar er markerte med [M: ...].

**Empirisk grunnlag.** Der traktaten viser til kvantitative funn, er desse henta frå analysar av STOLAR-datasettet (n ca. 2300 objekt, 1280-2024) frå eit norsk nasjonalmuseum, og ein detaljstudie av 93 stolar frå same samling. Tala er illustrasjonar, ikkje premissar. Rammeverket held utan dei.

**Kjeldetilvisingar.** Referansar til BibTeX-nøklar er markerte i teksten med klammer, t.d. [thompson1917growth].
...
> *Falsifiseringsvilkår*: Postulatet fell om det kan visast at minst eitt av vilkåra (a), (b), (c) krev ein eigenskap som berre organisk materie har [levin2019boundary].
...
**5.32** [Observasjon] Definisjonen fangar *omvegskapasitet* (detour) men ikkje *målrekonstruksjon*: evna til å gjenopprette G frå ufullstendig informasjon. Ein planaria som regenererer hovud frå vev som aldri har vore hovud-nært rekonstruerer måltilstanden frå deldata [lobo2015planarian]. Ein meistarhandverkar som fullfører eit halvferdig stykke rekonstruerer designintensjonen frå det som finst. Denne kapasiteten er ein komponent av intelligens som det formelle målet I(N) ikkje fangar fullt ut.
...
**7.1** [Aksiom] **Postulat om stiavhengig tilpassingsverdi.** Tilpassingsfunksjonen opererer ikkje berre på posisjonar, men på vegar gjennom formrommet. Lat gamma : [0, T] -> M_C vere ein stig. Tilpassingsverdien er eit funksjonale [M: Postulat 9.1]:
...
> *Falsifiseringsvilkår*: Postulatet fell om identiske former med ulik produksjonshistorie konsekvent har same overlevings- og reproduksjonsrate.

**7.11** [Teorem: følger av 7.1] **Stasjonær veg.** Blant alle moglege vegar frå **x_0** til **x_T** realiserer seg den som gjer S[gamma] stasjonær: deltaS[gamma] = 0. Same prinsipp styrer lys (Fermats prinsipp), mekanikk (Hamiltons prinsipp) og elektriske krinsar (Kirchhoffs lover) [kaila2008leastaction]. [M: Teorem 9.2]

**7.12** [Teorem: følger av 7.11] Å gi form er ikkje å finne den beste posisjonen, men den beste *vegen*. Prosessen er ikkje berre resultatet; prosessen *er* resultatet, fordi vegen endrar landskapet undervegs (4.2). [M: Teorem 9.3]
